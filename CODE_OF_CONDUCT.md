...
When an incident does occur, it is important to report it promptly. To report a possible violation, **You can report any issues or violations to our Community Manager, via Matrix or email. 
To report via email, please message support@H5P.com with the subject header line 'Community Manager - Code of conduct report '.**
